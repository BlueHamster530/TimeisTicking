...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField]
    private float ShakeAngleAmount = 1.0f;
    private float ShakeTime;
    [SerializeField]
    private float testanglespeedgo = 100.0f;
    [SerializeField]
    private float testanglespeedback = 100.0f;
    ...
    [SerializeField]
    private float TargetorthographicSize = 5.3f;
    [SerializeField]
    private float TargetOrtSizeTime = 0.1f;
    [SerializeField]
    ...
    {
       // if (IsCloseupAlreadyStart == true) return;
